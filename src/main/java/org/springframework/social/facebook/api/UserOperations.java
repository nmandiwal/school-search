...
public interface UserOperations {
	 ...
	 * @throws ApiException                  if there is an error while
	 *                                       communicating with Facebook.
	 * @throws MissingAuthorizationException if FacebookTemplate was not created
	...
	/**
	 * Retrieves the user's profile image. Returns the image in Facebook's "normal"
	 * type.
	 * 
	...
	/**
	 * Retrieves the user's profile image. When height and width are both used, the
	 * image will be scaled as close to the dimensions as possible and then cropped
	 * down.
	 * 
	...
	/**
	 * Retrieves a list of permissions that the application has been granted for the
	 * authenticated user.
	 * 
	...
	/**
	 * Fetches IDs that the user has on any applications associated with the calling
	 * application via Facebook's Business Mapping API.
	 * 
	 * @return a list of ID-to-application mapping that the user has on related
	 *         applications.
	 */
	List<UserIdForApp> getIdsForBusiness();

	/**
	 * Fetches a list of places that the user has checked into or has been tagged
	 * at.
	 * 
	 ...
	 * @return a list of {@link Reference}s, each representing a user who matched
	 *         the given query.
	 * @throws ApiException                  if there is an error while
	 *                                       communicating with Facebook.
	 * @throws MissingAuthorizationException if FacebookTemplate was not created
	...
	static final String[] PROFILE_FIELDS = { "id", "about", "age_range", "birthday", "cover", "currency", "devices",
